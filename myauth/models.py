...
class MyUser(AbstractBaseUser):
    ...
    departament = models.ForeignKey('Departamento', null=True)
    calendarioUser = models.OneToOneField('schedule.Calendar', null=True)
...
class Departamento(models.Model):
    ...
    jefe = models.OneToOneField('MyUser')
    calendario = models.OneToOneField('schedule.Calendar', null=True)

    def __str__(self):
        return 'Departamento de: ' + self.nombre
